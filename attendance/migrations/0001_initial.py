# Generated by Django 6.0.3 on 2026-04-03 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('TEACHER', 'Teacher'), ('CR', 'Class Representative')], default='TEACHER', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statuses', to='attendance.attendancerecord')),
